...
sockaddr_in Client::serverStructure()
{
...
bool Client::connectionHandling(sockaddr_in serveraddr)
{
...
void Client::sendReq(const std::string &req)
{
...
void Client::recvIntoBin(std::string filename){
